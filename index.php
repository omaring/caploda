...
<html lang="ja">
    ...
    <body>
            ...
            <div class="container">
                <div class="col-sm-3">
                    <select class="form-control" onChange="top.location.href = value">
                        <option <?=($sort==ORDER_CREATED_DESC) ? "selected='selected'" : ""; ?> value="?sort=<?=h(ORDER_CREATED_DESC); ?>">
                            投稿日が新しい順
                        </option>
                        <option <?=($sort==ORDER_CREATED_ASC) ? "selected='selected'" : ""; ?> value="?sort=<?=h(ORDER_CREATED_ASC); ?>">
                            投稿日が古い順
                        </option>
                        <option <?=($sort==ORDER_VIEWED_DESC) ? "selected='selected'" : ""; ?> value="?sort=<?=h(ORDER_VIEWED_DESC); ?>">
                            閲覧数が多い順
                        </option>
                        <option <?=($sort==ORDER_VIEWED_ASC) ? "selected='selected'" : ""; ?> value="?sort=<?=h(ORDER_VIEWED_ASC); ?>">
                            閲覧数が少ない順
                        </option>
                    </select>
                </div>
        ...
        <!--show_image()は引数が無ければ全画像を表示--> 
        <div class="container">
            <div class="row">
                <!--画像を繰り返し表示--> 
                <?php $image_view->show_image_all($sort); ?>
            </div>
        </div>
